...
<tr>
  <td width="40%" valign="top">
    <table id="management-links" style="padding-left: 2em;">
      [@menuitem image="user.gif" link="/security/user" name="用户管理" remark="创建用户,修改密码,分配角色"/]
      [@menuitem image="role.gif" link="/security/role" name="角色管理" remark="创建角色,修改角色,维护角色对应的用户,分配资源权限和数据权限"/]
      [@menuitem image="menu.gif" link="/security/nav/menu" name="菜单资源" remark="注册/启用/禁用资源,创建菜单配置,维护菜单项,启用/禁用菜单"/]
      [@menuitem image="monitor.gif" link="/security/session/monitor" name="系统监控" remark="管理在线用户,控制在线数量,查询登录历史"/]
    </table>
  </td>
  <td valign="top">
