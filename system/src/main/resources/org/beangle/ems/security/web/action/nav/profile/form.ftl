...
[@b.form action="!save" theme="list" title="info.module.detail"]
  ...
  [@b.select name="menuProfile.role.id" label="entity.role" option=r"${item.indexno} ${item.name}" value=(menuProfile.role.id)! required="true" style="width:250px;" items=roles/]
  [@b.formfoot]
