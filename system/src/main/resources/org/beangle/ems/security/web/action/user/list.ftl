...
[@b.grid items=users var="user"]
  ...
  bar.addItem("${b.text("action.export")}",action.exportData("name,fullname,mail,members,creator.fullname,effectiveAt,invalidAt:common.invalidAt,passwordExpiredAt,createdAt:common.createdAt,updatedAt:common.updatedAt,enabled","Xls","&fileName=用户信息"));
  [/@]
  [@b.row]
    [@b.boxcol/]
